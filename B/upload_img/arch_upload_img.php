...
if	($CheckUpload	==	"Ok")	{
		...
		$nomFichier	=	$id;
		if	($nomUnique)	{	$nomFichier	.=	"_"	.	uniqid();	}
...
/*	* ******************************************************** */
if	($CheckUpload	==	"Ok")	{
		adn_myRedirection('crop.php'	.	$ParamEnGET	.	"&img="	.	$nomFichier);
}
		...
		<body>
				...
				<div id="contenu">
						<?php	if	(!isset($_FILES['userfile']))	{	?>
								...
								<form enctype="multipart/form-data" action="<?php	echo	$ParamEnGET;	?>" method="post">
