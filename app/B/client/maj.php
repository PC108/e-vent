...
// récupération et affichage des valeurs
		...
		$ordre_cheque	=	$row->CLI_ordre_cheque;
}
				...
				<div id="contenu">
						<form id="form_client" action="action.php" method="post">
								<div class="BoxSearch">
										...
										<h2>Chèque / Mandat</h2>
										<div class="form_hr">
												<div class="label_form label_R">Ordre du chèque</div>
												<div class="content_form">
														<input id="CLI_ordre_cheque" name="CLI_ordre_cheque" type="text" value="<?php	echo	htmlspecialchars($ordre_cheque);	?>" size="40" class="form_R">
														<div class="note">Ordre a qui adresser le chèque. Cette information apparaitra lorsque l'utilisateur aura choisi le paiment par chèque pour honorer sa commande. Si le champ est vide, aucune information ne sera affichée.</div>
												</div>
										</div>
